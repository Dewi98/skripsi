...
<html lang="en">
    <head>
        <title>LOBSTER &mdash; @yield('title')</title>
        <meta charset="utf-8">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-6 col-md-4 order-2 order-md-1 site-search-icon text-left">
                                {{ Form::open(['route' => 'produk', 'class' => 'site-block-top-search', 'method' => 'GET']) }}
                                    ...
                                    {{ Form::text('search', null, ['class' => 'form-control border-0', 'placeholder' => 'Cari...']) }}
                            ...
                            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
                                <div class="site-logo">
                                    <a href="{{ route('beranda') }}" class="js-logo-clone">Lobster</a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="block-5 mb-5">
                                ...
                                <ul class="list-unstyled">
                                    <li class="address">Majalengka</li>
                                    <li class="phone"><a href="tel://+6285812345678">+6285812345678</a></li>
                                    <li class="email">dewi</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4">
