                    ...
                    <div class="col-md-12">
                        ...
                        <div class="p-3 p-lg-5 border">
                                ...
                                <div class="collapse show" id="collapsebank">
                                    <div class="py-2">
                                        <p class="mb-0 text-black">
                                            ...
                                            {{ Html::image(asset('user_assets/images/mandiri_logo.jpg')) }} 121211111212 a/n dewi<br><br>
                                            <small>
                            ...
                            <div class="form-group">
                                ...
                                <button type="button" onClick="prosesPesanan({{$biaya}})" class="btn btn-primary btn-lg py-3 btn-block">Proses Pesanan Midtrans</button>
                            </div>
...
<script>
    function prosesPesanan(biaya) {
        let alert = document.getElementById('alert');
        let total = parseInt(biaya) + parseInt(ongkir);
        let nama = document.getElementById('inp_nama_penerima').value;
        let telepon = document.getElementById('inp_no_telepon').value;
        let alamatTujuan = document.getElementById('inp_alamat_tujuan').value;
        let provinsi = document.getElementById('inp_provinsi').value;
        let kota = document.getElementById('inp_kota');
        let layanan = document.getElementById('inp_layanan');
        let html = `
    ...
    $(document).ready(function(){
        ...
        $.get(url+'/get_provinsi').done(function(result){
            if($.parseJSON(result)['rajaongkir']['status']['code'] == 200) {
                ...
                console.log('Terjadi Kesalahan Saat Menghubungi Server')
            }
        })
        $('#inp_provinsi').click(() => {
        ...
        $('#inp_layanan').click(() => {
            ...
            ongkir = $('#inp_layanan').find(':selected').val();
        })
    })
</script>
@endsection
