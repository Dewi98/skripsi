...
<h1>
    Laporan Transaksi
    <small>Halaman print laporan transaksi</small>
</h1>
<ol class="breadcrumb">
    <li><a href="{{ route('beranda_admin') }}"><i class="fa fa-home"></i> Beranda</a></li>
    <li><i class="fa fa-file-pdf-o fa-fw"></i> Laporan</li>
            ...
            <div class="box-body">
                    ...
                    <div class="col-md-12 col-md-offset-2">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <a href="{{ route('laporan_transaksi') }}" class="btn btn-warning"><i class="fa fa-refresh fa-fw"></i> Reset</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group text-center">
                        <button type="submit" class="btn btn-primary" target="_blank"><i class="fa fa-file-pdf-o fa-fw"></i> Print Laporan</button>
                    </div>
                    {{ Form::close() }}
                </div>
                @endif
